  ...
  keys = {
    {
      ...
      function()
        ...
        require("utils.owner_code_search").owner_code_grep(team, pattern)
      end,
    ...
    },
    {
      ...
      function()
        ...
        require("utils.owner_code_search").owner_code_grep_pattern(team, pattern)
      end,
      desc = "Owner Code Grep Search",
    },
    {
      ...
      function()
        ...
        require("utils.owner_code_search").owner_code_fd(team, pattern)
      end,
    ...
    },
    {
      ...
      function()
        ...
        require("utils.owner_code_search").owner_code_fd_pattern(team, pattern)
      end,
      desc = "Owner Code Fd Search",
    },
  },
  config = function()
    local owner_code_grep = require("utils.owner_code_search").owner_code_grep
    ...
    local owner_code_grep_pattern = require("utils.owner_code_search").owner_code_grep_pattern
    ...
    local owner_code_fd = require("utils.owner_code_search").owner_code_fd
    ...
    local owner_code_fd_pattern = require("utils.owner_code_search").owner_code_fd_pattern
